...
Notebook 07 does the same work interactively.
...
| `generate_jobs.py` | Writes the twelve complete NVFLARE job folders under `deployment/jobs/`, each carrying the code the hospitals run, and copies them into the admin's `transfer/` directory. |
