...
JSON to `deployment/datasets/dataset_audit.json`. Exits non-zero if any check fails.
...
def write_docs(source, glob_, parts, prov) -> None:
    ...
    L = [
        ...
        "`deployment/code/scripts/audit_dataset.py`. Every number below is read from the data, not "
