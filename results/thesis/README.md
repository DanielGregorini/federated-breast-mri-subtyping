# results/thesis — the thirteen reported results

Everything the dissertation reports comes from this folder and from nowhere else. One
subfolder per experiment, plus `final_summary/`. Nothing else lives here, and nothing
here should ever be overwritten. A new campaign you run yourself is collected into
[`results/federated/`](../federated/README.md) instead.
