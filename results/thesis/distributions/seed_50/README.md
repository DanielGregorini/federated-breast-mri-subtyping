# Dataset organization — seed 50

How the data is divided for every experiment run at seed 50, and the listings
...
|---|---:|---|---:|---:|
| `2_clients_balanced_s50` | 2 | stratified | 1527 | 12,131 |
| `3_clients_balanced_s50` | 3 | stratified | 1527 | 12,131 |
| `3_clients_cohort_s50` | 3 | cohort | 1527 | 12,131 |
| `3_clients_sizematched_s50` | 3 | stratified | 1527 | 12,131 |
| `4_clients_balanced_s50` | 4 | stratified | 1527 | 12,131 |
| `4_clients_skewed_s50` | 4 | stratified | 1527 | 12,131 |
...
|---|---|---|---:|---:|---:|---:|---:|
| `2_clients_balanced` | hospital_1 | train | 612 | 4,862 | 310 | 164 | 138 |
| `2_clients_balanced` | hospital_1 | val | 152 | 1,204 | 77 | 41 | 34 |
| `2_clients_balanced` | hospital_2 | train | 611 | 4,853 | 309 | 164 | 138 |
| `2_clients_balanced` | hospital_2 | val | 152 | 1,212 | 77 | 41 | 34 |
| `3_clients_balanced` | hospital_1 | train | 408 | 3,243 | 206 | 110 | 92 |
| `3_clients_balanced` | hospital_1 | val | 102 | 816 | 52 | 27 | 23 |
| `3_clients_balanced` | hospital_2 | train | 408 | 3,245 | 206 | 110 | 92 |
| `3_clients_balanced` | hospital_2 | val | 102 | 805 | 52 | 27 | 23 |
| `3_clients_balanced` | hospital_3 | train | 406 | 3,217 | 206 | 109 | 91 |
| `3_clients_balanced` | hospital_3 | val | 101 | 805 | 51 | 27 | 23 |
| `3_clients_cohort` | hospital_1 | train | 514 | 4,052 | 341 | 82 | 91 |
| `3_clients_cohort` | hospital_1 | val | 128 | 1,022 | 85 | 20 | 23 |
| `3_clients_cohort` | hospital_2 | train | 82 | 652 | 34 | 22 | 26 |
| `3_clients_cohort` | hospital_2 | val | 19 | 152 | 8 | 5 | 6 |
| `3_clients_cohort` | hospital_3 | train | 627 | 5,009 | 244 | 225 | 158 |
| `3_clients_cohort` | hospital_3 | val | 157 | 1,244 | 61 | 56 | 40 |
| `3_clients_sizematched` | hospital_1 | train | 514 | 4,089 | 260 | 138 | 116 |
| `3_clients_sizematched` | hospital_1 | val | 128 | 1,017 | 65 | 34 | 29 |
| `3_clients_sizematched` | hospital_2 | train | 81 | 633 | 41 | 22 | 18 |
| `3_clients_sizematched` | hospital_2 | val | 20 | 159 | 10 | 5 | 5 |
| `3_clients_sizematched` | hospital_3 | train | 628 | 4,997 | 318 | 169 | 141 |
| `3_clients_sizematched` | hospital_3 | val | 156 | 1,236 | 79 | 42 | 35 |
| `4_clients_balanced` | hospital_1 | train | 306 | 2,435 | 155 | 82 | 69 |
| `4_clients_balanced` | hospital_1 | val | 77 | 615 | 39 | 21 | 17 |
| `4_clients_balanced` | hospital_2 | train | 305 | 2,418 | 154 | 82 | 69 |
| `4_clients_balanced` | hospital_2 | val | 77 | 606 | 39 | 21 | 17 |
| `4_clients_balanced` | hospital_3 | train | 305 | 2,423 | 154 | 82 | 69 |
| `4_clients_balanced` | hospital_3 | val | 76 | 608 | 39 | 20 | 17 |
| `4_clients_balanced` | hospital_4 | train | 305 | 2,422 | 154 | 82 | 69 |
| `4_clients_balanced` | hospital_4 | val | 76 | 604 | 39 | 20 | 17 |
| `4_clients_skewed` | hospital_1 | train | 678 | 5,384 | 343 | 182 | 153 |
| `4_clients_skewed` | hospital_1 | val | 170 | 1,353 | 86 | 46 | 38 |
| `4_clients_skewed` | hospital_2 | train | 273 | 2,167 | 138 | 73 | 62 |
| `4_clients_skewed` | hospital_2 | val | 67 | 536 | 34 | 18 | 15 |
| `4_clients_skewed` | hospital_3 | train | 136 | 1,082 | 69 | 37 | 30 |
| `4_clients_skewed` | hospital_3 | val | 34 | 272 | 17 | 9 | 8 |
| `4_clients_skewed` | hospital_4 | train | 135 | 1,072 | 69 | 36 | 30 |
| `4_clients_skewed` | hospital_4 | val | 34 | 265 | 17 | 9 | 8 |
...
python deployment/code/scripts/build_distribution_report.py --seed 50
```
